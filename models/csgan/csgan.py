# Code inspired from https://github.com/KishanKancharagunta/CSGAN
...
class CSGAN(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'CSA', 'CSB']
    ...
    def backward_G(self):
        ...
        # combined loss
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_CSA + self.loss_CSB  + self.loss_cycle_A + self.loss_cycle_B  + self.loss_idt_A + self.loss_idt_B
